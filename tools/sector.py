...
def register(mcp) -> None:
    ...
    async def sector_snapshot(
        ...
        """Sector snapshot — median ratios (P/E, P/S, P/B, EV/EBITDA, margins,
        yield), the top and bottom names by composite_value_score, and the
        aggregate earnings-growth trend for a GICS sector.
